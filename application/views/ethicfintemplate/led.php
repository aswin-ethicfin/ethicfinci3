            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <h6 class="text-white text-capitalize ps-3">Leeds</h6>
                    </div>	  
                </div>
                        ...
                        <table class="table align-items-center justify-content-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Lead Type</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">From</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Contact</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Next Contact Date</th>
