            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        ...
                        <h6 class="text-white text-capitalize ps-3">Stock Reconciliation</h6>
                    </div>	  
                </div>
                        ...
                        <table class="table align-items-center justify-content-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">DOC.NO</th>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">F QTY</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">TOTAL QTY</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">MRP</th>
