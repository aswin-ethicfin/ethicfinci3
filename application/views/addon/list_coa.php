        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body px-4 py-3">
                    ...
                    <!-- Filter Form -->
                    <form method="get" action="<?= base_url('home/listLabImages') ?>" class="row g-3 mb-4">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="d-flex align-items-end h-100">
                                <div>
                                    ...
                                    <a href="<?= base_url('home/listLabImages') ?>" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
                                    ...
                                    <?php foreach ($images as $index => $img) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('home/editCOA?id=' . $img['id']) ?>"
                                                ...
                                                <form action="<?= base_url('home/deleteDocument') ?>"
                                                    ...
                                                    <input type="hidden" name="redirect" value="coa">
