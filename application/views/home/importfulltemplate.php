                ...
                <div class="card-body px-0 pb-2 ps-5 pe-5">
                    <div class="card-content">
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?=base_url()?>templates/forfullcolumnlatest" download="">
                                <span title="Excel sheet format" class="btn btn-primary">Download Full Excel Format</span>
                            </a>
                        </div>
                    </div>
                </div>
...
<?php $ref=1;?>
 ...
 var fileName = file_data.name;
    ...
    $.ajax({
       url: "<?= base_url() ?>home/importinvoicesfromexcelfullformat", 
        dataType: 'text', 
        cache: false,
        contentType: false,
        processData: false,
...
function showproducts2(s) {
  ...
  if (file_data) {
    ...
    if (fileExtension === 'xls' || fileExtension === 'xlsx') {
      ...
      $.ajax({
        url: "<?= base_url() ?>home/confirmfullexcelupload",
        dataType: 'text',
        cache: false,
        contentType: false,
        processData: false,
