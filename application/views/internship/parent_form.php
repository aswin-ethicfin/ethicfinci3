                ...
                <div class="card-body px-0 pb-2 ps-5 pe-5">
                    ...
                    <body style="font-family: Arial, sans-serif; background-color: #f4f4f9;" >
                        ...
                        <div style="width: 50%; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.1);">
                            ...
                            <form method="POST" action="<?= base_url('home/submitparent') ?>">
                            <div style="margin-bottom: 15px;" class="col-md-12">
                                    <label for="parent_name" style="display: block; font-size: 1rem; color: #555; margin-bottom: 5px;">Parent's Name:</label>
                                    <input type="text" id="parent_name" name="parent_name" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 1rem;">
                            </div>
                            <div style="margin-bottom: 15px;" class="col-md-12">
                                <label for="child_name" style="display: block; font-size: 1rem; color: #555; margin-bottom: 5px;">Child's Name:</label>
                                <input type="text" id="child_name" name="child_name" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 1rem;">
                            </div>
                            ...
                            <div style="margin-bottom: 15px;" class="col-md-12">
                                    ...
                                    <input type="text" id="contact_number" name="contact_number" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 1rem;">
                            </div>
                            <div style="margin-bottom: 15px;" class="col-md-12">
                                <label for="address" style="display: block; font-size: 1rem; color: #555; margin-bottom: 5px;">Address:</label>
                                <input type="text" id="address" name="address" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-size: 1rem;">
                            </div>
