            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2 ps-5 pe-5">
                    <div class="card-content">
                        <h2 style="text-align: center; margin-bottom: 30px;">Industry Data Setting Form</h2>
                        <form action="<?= base_url('home/submit_setting') ?>" method="POST">
                            ...
                            <div style="margin-bottom: 25px;">
                                ...
                                <div id="settingsCheckboxes" style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 10px;">
                                    ...
                                    <label style="font-size: 16px;"><input type="checkbox" value="1" onchange="updateSettings()" style="transform: scale(1.3); margin-right: 10px;" checked> Trading</label>
